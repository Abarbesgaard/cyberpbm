...
export function LandingPage() {
  return (
    <section className="relative flex min-h-screen flex-col justify-center overflow-hidden px-8 pt-28 pb-16 md:px-16">
      ...
      <h1 className="relative z-10 max-w-[900px] font-head font-black text-foreground leading-[0.9] tracking-tight uppercase text-[clamp(4rem,10vw,8.5rem)]">
        <span
          className="glitch block text-cp-red-bright"
      ...
      {/* Subtitle */}
      <p className="relative z-10 mt-8 max-w-[560px] border-l-[3px] border-cp-red pl-5 text-[1.1rem] font-normal leading-relaxed text-cp-off">
        You do not roll dice. You commit. The city resolves.
        <br />
        Every round, two action slots. Every decision hurts.
        <br />
        Night City doesn't wait.
      </p>

...
const paragraphs = {
  player: [
    "The game is played via mails or in strictly governed chat fora. You will never have all the information you need to make the best decision — but if you align with other players, hack into the right servers, or blow up the right building, you just might get ahead of the competition to rule Night City.",
  ...
  gm: [
    "The game is played via mails or in strictly governed chat fora. Players operate under incomplete information — they see what you choose to reveal, and no more. Your job is to make that fog feel alive.",
    "The core mechanic is the operation grid. Players submit theirs each round; you build the opposition grid in secret. The collision between the two produces the story. The Grid is explained in detail in its dedicated section.",

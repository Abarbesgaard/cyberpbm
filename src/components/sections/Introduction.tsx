...
const body = {
  ...
  gm:
    "Welcome, City. This manual is your operating guide for running CyberPBM — designing missions, building opposition grids, managing heat, and keeping the world alive between rounds. The players see rules. You see levers.",
  default:
